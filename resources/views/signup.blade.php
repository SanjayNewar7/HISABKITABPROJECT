...
body {
    ...
    line-height: 1.6;
    width:100%;
    background-image: url(http://127.0.0.1:8000/images/ladingpage.png);
...
button:hover{
    ...
    <div class="signin-container">
        <h2>Get Started</h2>
        <form id="signin-form" action="{{ route('signup.post') }}" method="post">
            @csrf
                ...
                <input type="text" for="number" name="phone_number" id="number" placeholder="+977 98......">
                <label for="pan-num">Pan number</label>
                <input type="text" for="pan-num" name="pan_num" id="pan-num" placeholder="989...">
