...
<script>
    // Pull real table data from Laravel
    ...
    document.getElementById('bookingForm').addEventListener('submit', function(e) {
      ...
      const index = tableData.findIndex(t => t.table_number === tableNumber);
      if (index !== -1) {
        tableData[index].table_status = newStatus;
        renderTables();
        alert(`Table ${tableNumber} updated to ${newStatus}`);
      } else {
        alert(`Table ${tableNumber} not found.`);
      }
    });
</script>
