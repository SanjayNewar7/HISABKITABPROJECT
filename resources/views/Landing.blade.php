        ...
        <div class="container">
            <div class="text">
                <h5 class="scroll-hidden">Smarter Decisions Start
                    ...
                    <div class="start_btn scroll-hidden scroll-slide-left">Get started</div>
            </div>
            <div class="image scroll-hidden scroll-zoom-in" ><img src="image/dashboard.png" alt="">

            </div>

        </div>
       <!-- <-----serive we provide---->
        <div class="service_heading ">service we provide</div>
        <div class="service">

            <div class="total  scroll-hidden">
                <img src="image/7479646_questionnaire_survey_checklist_list_clipboard_icon 1.png" alt=""><span>Total Orders</span>
            ...
            <div class="sales scroll-hidden">
                <img src="image/5027854_analytics_business_chart_graph_statistics_icon 1.png" alt="">
            ...
            <div class="peakhour scroll-hidden">
                <img src="image/2530808_alarm_clock_deadline_general_office_icon (1) 1.png" alt="">
            ...
            <div class="topselling scroll-hidden ">
                <img src="image/10934659_top_brand_quality_product_shopping_icon 1.png" alt="">
        ...
        <div class="security">
            <img src="image/331815476_7a1c2c3a-48b0-4190-aea9-4ae1534fa7dd-removebg-preview 1.png" class="scroll-hidden scroll-slide-left">
        ...
        <img src="image/logo 1.png" class=" scroll-hidden scroll-slide-right">
